...
import { PrismaWorkshopWithPricesAndSeason } from '@/lib/services/workshop.service';
import { toWorkshopPricesWithSeasonInfoDTO } from '@/lib/mappers/workshopPrice.mapper';
